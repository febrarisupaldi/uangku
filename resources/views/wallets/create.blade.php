...
<div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Tambah Dompet</h2>
    ...
    <form action="{{ route('wallets.store')}}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        @csrf
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            <div class="relative">
                ...
                <select name="wallet_type_id" required
                    class="pl-10 pr-4 py-3 w-full rounded-lg border dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                    <option value="" disabled selected>-- Pilih Tipe Dompet --</option>
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            <div class="relative">
                ...
                <input type="number" name="wallet_balance" id="wallet_balance" required
                    class="pl-10 pr-4 py-3 w-full rounded-lg border dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    placeholder="Saldo" value="0">
            </div>
        </div>
