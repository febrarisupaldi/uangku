...
INSERT INTO `incomes` VALUES (6,10,1,5000000.00,'2025-05-09','Gaji Bulan Mei','2025-05-09 15:22:36',NULL),(8,13,2,1000000.00,'2025-11-07','Test Gaji','2025-11-07 15:24:09',NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`paldi`@`localhost`*/ /*!50003 TRIGGER `after_insert_incomes` AFTER INSERT ON `incomes` 
    FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`paldi`@`localhost`*/ /*!50003 TRIGGER `after_delete_incomes` AFTER DELETE ON `incomes` 
    FOR EACH ROW BEGIN
