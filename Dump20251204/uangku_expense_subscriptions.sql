...
DROP TABLE IF EXISTS `expense_subscriptions`;
...
--
-- Dumping data for table `expense_subscriptions`
--

LOCK TABLES `expense_subscriptions` WRITE;
/*!40000 ALTER TABLE `expense_subscriptions` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_subscriptions` ENABLE KEYS */;
UNLOCK TABLES;
