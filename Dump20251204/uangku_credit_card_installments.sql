...
--
-- Dumping data for table `credit_card_installments`
--

LOCK TABLES `credit_card_installments` WRITE;
/*!40000 ALTER TABLE `credit_card_installments` DISABLE KEYS */;
/*!40000 ALTER TABLE `credit_card_installments` ENABLE KEYS */;
UNLOCK TABLES;
