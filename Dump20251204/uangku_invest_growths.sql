...
DROP TABLE IF EXISTS `invest_growths`;
...
--
-- Dumping data for table `invest_growths`
--

LOCK TABLES `invest_growths` WRITE;
/*!40000 ALTER TABLE `invest_growths` DISABLE KEYS */;
/*!40000 ALTER TABLE `invest_growths` ENABLE KEYS */;
UNLOCK TABLES;
