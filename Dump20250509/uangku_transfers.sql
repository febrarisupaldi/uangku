...
INSERT INTO `transfers` VALUES (2,10,2,500000.00,'Tarik dari ATM','2025-05-09','2025-05-09 15:42:28');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`paldi`@`localhost`*/ /*!50003 TRIGGER `after_insert_transfers` AFTER INSERT ON `transfers` 
    FOR EACH ROW BEGIN
	select balance into @balance1 from wallet_details where wallet_id = new.from_wallet_id;
	select balance into @balance2 from wallet_details where wallet_id = new.to_wallet_id;
